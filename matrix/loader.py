    ...
    def reload(self) -> bool:
        ...
        for m in data["models"]:
            model = Model(
                ...
                active=float(m["active"]),
                license=m["license"],
                ram_q4_gb=float(m["ram_q4_gb"]),
                vram_q4_gb=float(m["vram_q4_gb"]),
                cpu_tps_ampere=float(m["cpu_tps_ampere"]),
                gpu_tps_3090=float(m.get("gpu_tps_3090", 0.0)),
                gpu_tps_a100=float(m.get("gpu_tps_a100", 0.0)),
